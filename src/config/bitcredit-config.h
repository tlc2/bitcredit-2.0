/* src/config/bitcredit-config.h.  Generated from bitcredit-config.h.in by configure.  */
/* src/config/bitcredit-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BITCREDIT_CONFIG_H

#define BITCREDIT_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcredit Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcredit Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bitcredit/bitcredit/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bitcredit Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcredit Core 0.12.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcredit"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitcreditcore.org/"
