...
maintained:
* for `src/secp256k1`: https://github.com/bitcredit/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/bitcredit/leveldb.git (branch bitcredit-fork)
* for `src/univalue`: https://github.com/bitcredit/univalue.git (branch master)
